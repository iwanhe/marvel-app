    ...
    <>
            ...
            return (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  {isDefault && (
                    <span style={{ fontFamily: "'Nunito', sans-serif", fontSize: 9, fontWeight: 800, background: color + "20", color, borderRadius: 4, padding: "1px 6px", letterSpacing: 0.3 }}>
                      DEFAULT
                    </span>
                  )}
                </div>
                <button
                  ...
                  style={{
                    border: "none",
                    background: isDefault ? "#F5F5F5" : "#FFEBEE",
                    color: isDefault ? "#CCC" : "#E53935",
      ...
      <div style={{ borderRadius: 14, background: "#fff", border: "1px solid #EBEBEB", padding: 14 }}>
        ...
        <div style={{ marginBottom: 10 }}>
          ...
          <input
            type="text"
            placeholder="Contoh: Les Matematika, Renang..."
            value={newActName}
            onChange={(e) => setNewActName(e.target.value)}
            onKeyDown={(e) => e.key === "Enter" && handleAdd()}
            style={{
              width: "100%", padding: "10px 12px", borderRadius: 10,
              border: "1px solid #E0E0E0", fontFamily: "'Nunito', sans-serif",
              fontSize: 13, background: "#FAFAFA", boxSizing: "border-box", outline: "none",
            }}
          />
        </div>
        ...
        {newActName.trim() && (
          <div style={{ marginBottom: 10, padding: "8px 12px", borderRadius: 10, background: "#F8F8F8", border: "1px solid #EBEBEB" }}>
            <div style={{ fontFamily: "'Nunito', sans-serif", fontSize: 11, color: "#AAA", marginBottom: 6, fontWeight: 700 }}>
              PREVIEW BADGE
            </div>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 4, background: "#55555518", border: "1px solid #55555535", borderRadius: 7, padding: "4px 9px" }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 700, color: "#555", fontFamily: "'Nunito', sans-serif" }}>
                {newActName.trim()}
              </span>
            </div>
          </div>
